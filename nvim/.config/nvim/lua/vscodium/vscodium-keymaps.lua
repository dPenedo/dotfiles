...
-- Harpoon
map("n", "<leader>ja", vscode_call("vscode-harpoon.addEditor"))
map("n", "<leader>jf", vscode_call("vscode-harpoon.editorQuickPick"))
map("n", "<leader>je", vscode_call("vscode-harpoon.editEditors"))
map("n", "<leader>jj", vscode_call("vscode-harpoon.gotoEditor1"))
map("n", "<leader>jk", vscode_call("vscode-harpoon.gotoEditor2"))
map("n", "<leader>jl", vscode_call("vscode-harpoon.gotoEditor3"))
map("n", "<leader>j;", vscode_call("vscode-harpoon.gotoEditor4"))