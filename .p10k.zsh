# Generated by Powerlevel10k configuration wizard on 2023-02-13 at 13:53 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_ADD_NEWLINE=true #cambiado
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=76 #cambiado
  # Red prompt symbol if the last command failed. typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=196
