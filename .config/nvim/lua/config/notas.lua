...
function new_md_file()
    ...
    local default_directory = '/home/daniel/Notas/'
...
vim.api.nvim_set_keymap('n', '<leader>nn', ":lua new_md_file()<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>nf', ':Telescope find_files cwd=' .. "/home/daniel/Notas" .. '<CR>',
