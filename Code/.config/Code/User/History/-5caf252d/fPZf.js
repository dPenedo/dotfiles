function updateTime() {
    ...
    fetch('http://worldtimeapi.org/api/timezone/America/Argentina/Salta')
        ...
        .then(data => {
            ...
            let hoursFromApi = datetimeString.slice(11, 13);
            let minutesFromApi = datetimeString.slice(14, 16);
            let secondsFromApi = datetimeString.slice(17, 19);
        });

    const secondHours = hoursFromApi;
    const secondMinutes = minutesFromApi;
    const secondSeconds = secondsFromApi;
