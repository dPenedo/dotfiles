...
-- Destroy all notifications
    ...
    awful.key({ modkey }, "Escape",
        function() awful.util.spawn("rofi -show powermenu -modi powermenu:~/scripts/rofi-power-menu") end,
    ...
    awful.key({ modkey }, "c", function() awful.util.spawn("gnome-calendar") end,
        { description = "Calendario", group = "Mis programas" }),
    awful.key({ modkey }, "g", function() awful.util.spawn("gpick") end,
    ...
    awful.key({ modkey }, "p", function() awful.util.spawn("playerctl play-pause") end,
        { description = "Pausar/reproducir media", group = "Mis programas" }),
    ...
    --         { description = "Subir volumen", group = "Sonido" }),
    --     awful.key({ modkey, }, "XF86AudioLowerVolume",
    --         function() awful.util.spawn("pactl set-sink-volume @DEFAULT_SINK@ -5%") end,
    --         { description = "Bajar volumen", group = "Sonido" }),
    ...
    -- awful.key({ modkey }, "b", function () awful.util.spawn(dmenu_run) end,
    --           {description = "run prompt", group = "launcher"}),
