...
theme.wallpaper                                 = theme.dir .. "/dragon.jpeg"
theme.font                                      = "Inter 12"
...
theme.taglist_fg_focus                          = "#7E9CD8"
theme.tasklist_bg_focus                         = "#222222"
theme.tasklist_fg_focus                         = "#7E9CD8"
...
local mytextclock = wibox.widget.textclock(markup("#7788af", " %A, %d %B ") ..
    markup("#ab7367", "|") .. markup("#e6c384", " %H:%M "))
...
--         widget:set_markup(markup.fontfg(theme.font, "#FEFEFE", net_now.devices["interface"]))
--     end
-- })
local wifi_icon = "wi-fi"
local eth_icon = "eth"
local net = lain.widget.net {
    notify = "off",
    wifi_state = "on",
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        s.mytasklist, -- Middle widget
        {
            ...
            wibox.container.background(
                wibox.container.margin(
                    wibox.widget { fsicon, theme.fs and theme.fs.widget, layout = wibox.layout.align.horizontal }, dpi(3),
                    dpi(3)),
                "#CB755B"),
            arrow("#CB755B", "#8DAA9A"),
            wibox.container.background(
                wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal },
                    dpi(3),
                    dpi(3)), "#8DAA9A"),
